...
suite('Unit Tests', () => {
    ...
    test('Translate Mangoes are my favorite fruit. to British English', (done) => {
        ...
        const result = translator.UStoUK(input);
    ...
    test("Translate Can you toss this in the trashcan for me? to British English", (done) => {
        ...
        const expected = 'Can you <span class="highlight">bin</span> this in the <span class="highlight">bin</span> for me?';
        const result = translator.UStoUK(input);
        assert.include(result, 'highlight');
        done();
    });
    ...
    test('Translate We watched the footie match for a while. to American English', (done) => {
        ...
        const result = translator.UKtoUS(input);
        assert.strictEqual(result, expected);
        done();
    });
